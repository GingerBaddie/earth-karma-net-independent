          ...
          <Card className="overflow-hidden">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full shadow-lg shadow-primary/20" disabled={submitting || verifying || !image || !verificationResult || !verificationResult.match || (verificationResult.confidence > 0 && verificationResult.confidence < 0.5)}>
